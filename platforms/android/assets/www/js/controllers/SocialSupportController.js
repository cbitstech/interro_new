(function () {
  ...
  function SocialSupportController(configurationService, $modalInstance, uuid, modalParameters) {
    ...
    {id:1, reason:'By telling him/her about my quitting smoking,'+
        ' I\'m making my quit attempt "official", thereby committing myself more to it.'},
    {id:2, reason:'Knowing I\'m attempting to quit, ' + 
        ' he/she will not offer me cigarettes or otherwise tempt me to smoke.'},
    {id:3, reason:'He/she will offer encouragement along the way.'},
    {id:4, reason:'He/she will support my decision to stop smoking'+
        ' and help me in tricky social situations.'},
    {id:5, reason:'He/she will reward me (e.g., dinner) for achieving ' + 
